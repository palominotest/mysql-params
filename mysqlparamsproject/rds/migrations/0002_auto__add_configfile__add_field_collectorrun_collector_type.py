...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('config_files', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('parameters', self.gf('jsonfield.fields.JSONField')(default=None, null=True, blank=True)),
            ('raw_content', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
        ...
        db.send_create_signal(u'rds', ['ConfigFile'])

        # Adding field 'CollectorRun.collector_type'
        db.add_column('collector_runs', 'collector_type',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('config_files')

        # Deleting field 'CollectorRun.collector_type'
        db.delete_column('collector_runs', 'collector_type')
