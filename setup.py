...
setup(
    name='python27-mysql-params',
    version='0.1b.dev',
    author='PalominoDB',
    author_email='oss@palominodb.com',
    packages=find_packages(),
    package_data={
        '': ['*.template', 'fixtures/*.json', 'static-raw/css/*.css', 'static-raw/img/*',
            'static-raw/js/*', 'templates/rds/*.html', 'templates/*.html']
    }, 
...
#hurry.filesize==0.9
    ...
    entry_points={
        'console_scripts': [
            'python27-mysql-params-manage = mysqlparamsproject.manage',
        ]
    }
)
